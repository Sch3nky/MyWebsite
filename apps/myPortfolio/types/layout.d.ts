...
import { Auth, AuthResponse, AuthRole } from './api';
...
export interface AuthContextProps {
    ...
    isAdmin: () => boolean;
    changeAuthData: (_data: Auth) => void;
    signOut: () => Promise<void>;
    hasAccess: (roles: AuthRole[]|undefined) => boolean;
}

export interface AlertContextProps {
    showDanger: (title: string, content: string) => void;
